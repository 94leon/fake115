...
(function () {
  'use strict';
  let Buffer, LZ4, LoginEncrypt_, browserInterface, bytesToHex, bytesToString, cloneInto, dictToForm, dictToQuery,
    ec115_compress_decode, ec115_decode, ec115_decode_aes, ec115_encode_data, ec115_encode_token, ec115_init, elliptic,
    g_ver, get_key, md4, md4_init, preLoginEncrypt, ref, sig_calc, sig_init, stringToBytes;
  ...
  ec115_encode_token = function (pub, tm, cnt) {
    let i, l, m, o, q, r20, r21, tmp, tmp2;
  ...
  ec115_encode_data = function (data, key) {
    let aesEcb, i, j, k, key1, key2, l, n, part, rets, tmp;
    key1 = key.slice(0, 16);
    key2 = key.slice(-16);
  ...
  sig_init = function (body) {
    let data_buf, data_buf_p, dhash, md4h, ori_data_p, pSig, sz;
  ...
  sig_calc = function ({data_buf, data_buf_p, pSig, dhash}, src) {
    let h1, h1_p, h2, h2b, i, l, md4h, out_data, out_data_p, pad, ret, sz, xxh;
    xxh = XXH.h64();
  ...
  unsafeWindow.document.addEventListener('DOMContentLoaded', function () {
    let cont, error, fakeSizeLimitGetter, fastSig, fastUpload, finput, getUserKey, js_top_panel_box, procLabel,
      uploadinfo;
    try {
